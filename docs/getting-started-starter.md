...
Claude Code now has your skills and agents. **Meet your team first** - type:

```
/showcase
```

This deploys the full pipeline (planner -> tdd-guide -> code-reviewer -> security-reviewer)
on one small real utility so you watch your army work, once, on purpose, and keep tested,
reviewed code. About ten minutes. See [showcase-quickstart.md](showcase-quickstart.md).

Then point it at your own work. Try:
